# Copied verbatim from adapters/codex-native-reviewer/v1/normalize.jq at
# 5868e889ec5ea800ad0e36b99fe583b36b93ec85 — keep in sync; the planner must
# accept exactly what the normalizer emits and nothing else.
...
# End of the block copied from the Codex native reviewer normalizer.
