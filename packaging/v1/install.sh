...
denied_content='(/Users/|/home/[A-Za-z0-9._-]+|/root([^A-Za-z0-9._-]|$)|ghp_[A-Za-z0-9]{10}|github_pat_[A-Za-z0-9_]{10}|xox[abpr]-[A-Za-z0-9]{8}|sk-ant-|AKIA[0-9A-Z]{16}|BEGIN [A-Z ]+PRIVATE KEY|ystack-shipped-default)'
